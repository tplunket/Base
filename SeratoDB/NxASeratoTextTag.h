...
#ifndef __SeratoDB__NxASeratoTextTag__
#define __SeratoDB__NxASeratoTextTag__
...
namespace NxA {
    ...
    class SeratoTextTag : public SeratoTag
    {
    private:
...
#endif /* defined(__SeratoDB__NxASeratoTextTag__) */
