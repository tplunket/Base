...
#define TAGLIB_INTERNAL_UNUSED_STRINGIFY(string_literal) #string_literal
#define TAGLIB_IGNORE_DEAD_STORE(variable) _Pragma(TAGLIB_INTERNAL_UNUSED_STRINGIFY(unused(variable)))
...
#define TAGLIB_IGNORE_DEAD_STORE(variable) do { } while (0);
#else
